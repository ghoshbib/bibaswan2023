...
param(
 ...
 [string]
 $deploymentName = 'Submission Feedback Logic App Deployment',
...
#$connectionExists = Get-AzResource -ApiVersion '2016-06-01' -ResourceType "Microsoft.Web/connections" -ResourceGroupName $resourceGroupName -ResourceName "SubmissionFeedback" -ErrorAction SilentlyContinue

#if(!$connectionExists)
#{
	New-AzResource -Properties @{"api" = @{"id" = "subscriptions/" + $subscriptionId + "/providers/Microsoft.Web/locations/" + $resourceGroupLocation + "/managedApis/" + 'azureeventgrid'}; "displayName" = 'SubmissionFeedback'; } -ResourceName 'SubmissionFeedback' -ResourceType "Microsoft.Web/connections" -ResourceGroupName $resourceGroupName -Location $resourceGroupLocation -Force

	$connection = Get-AzResource -ApiVersion '2016-06-01' -ResourceType "Microsoft.Web/connections" -ResourceGroupName $resourceGroupName -ResourceName "SubmissionFeedback"
...
Write-Host "Starting deployment of Submission Feedback Logic App";
...
Write-Host "Completed deployment of Submission Feedback Logic App";